...
In order to craft an item, each 100gp of its **crafting cost** requires one day of work. Depending on the level, hiring a very skillful helper to aid in crafting at maybe 25gp per day can increase the productivity. Harder items, more expensive helpers.
...
>
>Due to the number of skilled smiths aiding in the process, and the speciality of the forge, it makes sense to assign a large number of people working on the item, so if 5 dwarves worked on the armor, the work would take 40 days to complete $20000 \times  \frac{1}{100} \times \frac{1}{5} = 40$
### Components
...
| Rarity    | Character Level | Value in DMG      | Crafting Cost in XGE | CR Range XGE |
| --------- | --------------- | ----------------- | -------------------- | ------------ |
| Common    | 1st or higher   | 50 - 100 gp       | 50 gp                | 1 - 3        |
| Uncommon  | 1st or higher   | 100 - 500 gp      | 200 gp               | 4 - 8        |
| Rare      | 5th or higher   | 500 - 5,000 gp    | 2000 gp              | 9 - 12       |
| Very rare | 11th or higher  | 5,000 - 50,000 gp | 20, 000 gp           | 13 - 18      |
| Legendary | 17th or higher  | 50,000+ gp        | 100, 000 gp          | 19 +         |
...
>[!Important]
>Item VALUE displayed is how much the item is worth, usually selling price. This is a base vlaue, and for calculating costs can be halved
...
| Upgrade to [[Leviathan Axe]] 2     | Legendary | 6000       |                                                                                                                                   |
